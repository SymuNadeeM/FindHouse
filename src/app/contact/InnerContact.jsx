      ...
      <div className=' relative '>
               ...
               <div className=" absolute px-[15px] bottom-[100px] md:bottom-[150px] md:left-[100px]">
                   <div className=" mt-[85px]">
                        <div className=" opacity-100 text-white font-nunito text-[16px] gap-2 flex items-center">
                            <p>Home</p>
                            <p>/</p>
                            <p>Contact</p>
                        </div>
                         <h4 className=" mt-[20px] font-nunito text-[40px] text-white font-bold leading-5">Contact</h4>
                   </div>
               </div>
          </div>
    </>
