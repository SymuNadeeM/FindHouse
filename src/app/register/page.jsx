...
import { AiOutlineGoogle, AiOutlineMail, AiOutlineUser } from 'react-icons/ai'
      ...
      <section className=' py-[60px] bg-[#f7f7f7] md:px-[90px]'>
        ...
        <div className=' px-[15px]'>
               <div className=' mb-[40px] flex flex-col items-center justify-center'>
                   <h2 className=' text-text-primary font-nunito  leading-5 mb-[10px] text-[24px] font-bold'>Register to your account</h2>
                   <p className=" py-[8px]  text-[16px] font-nunito text-[#777] leading-5 font-normal mb-[10px]">Already have an account?  <span><Link href={'/login'} className=' text-primary-color'>Login</Link></span> </p>
               </div>
             ...
             <div className=' gird md:col-span-1'>
               <form>
                  <div className=' flex items-center justify-between px-[12px] mb-[28px] w-full border-[1px] border-[#ddd] rounded-[5px] bg-white   h-[52px] leading-5'>
                      <input type="text" placeholder=' User Name ' className=' w-[85%]  outline-none text-[14px] font-nunito text-text-primary px-2 ' />
                          <AiOutlineUser  size={20} className=' text-text-primary' />
                  </div> 
                  <div className=' flex items-center justify-between px-[12px] mb-[28px] w-full border-[1px] border-[#ddd] rounded-[5px] bg-white   h-[52px] leading-5'>
                      <input type="email" placeholder=' Email ' className=' w-[85%]  outline-none text-[14px] font-nunito text-text-primary px-2 ' />
                          <AiOutlineMail  size={20} className=' text-text-primary' />
                  </div> 
                  <div className=' flex items-center justify-between px-[12px] mb-[28px] w-full border-[1px] border-[#ddd] rounded-[5px] bg-white   h-[52px] leading-5'>
                  ...
                  <div className=' flex items-center justify-between px-[12px] mb-[28px] w-full border-[1px] border-[#ddd] rounded-[5px] bg-white   h-[52px] leading-5'>
                      <input type="password" placeholder='Re-enter  Password' className=' w-[85%]  outline-none text-[14px] font-nunito text-text-primary px-2 ' />
                          <CiLock  size={20} className=' text-text-primary' />
                  </div> 
                  <div className=' mb-[1rem] items-center flex  justify-between'>
                    ...
                    <input type="checkbox" className='  w-[17px] h-[17px]   bg-primary-color border-primary-color text-white' />
                     <label htmlFor="" className=' inline-block cursor-pointer text-text-primary font-nunito text-[14px] pl-[15px]'>I have read and accept the Terms and Privacy Policy?</label>
                    </div>
                  </div>
                   <div className=''>
                       <button type='submite' className=' rounded-[8px] shadow-lg text-white font-nunito text-[16px] font-bold h-[50px] leading-5 bg-primary-color cursor-pointer w-full hover:border-[2px] border-primary-color hover:text-primary-color duration-300 hover:bg-white'> Register</button>
                   </div>
