...
const Loginregist = () => {
  ...
  return (
    <>
      <div>
          <div>
            <button className=' ' onClick={()=> setOneModel(!oneModel)} > button</button>
          </div>
           
           {oneModel? (<div className="  bg-black/75 fixed top-0 right-[50%] bottom-0 left-0 h-screen w-screen overflow-y-auto"> 
                  
             <div >
                <div className="bg-[#ffff]  absolute w-auto rounded-[8px] top-[80px] left-[277px] right-[277px] ">
                   <div className=' absolute top-[-20px] right-[-20px]  ' onClick={()=> setOneModel(!oneModel)}>
